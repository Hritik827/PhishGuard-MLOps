...
dagshub.init(
    repo_owner="Hritik827",
    repo_name="PhishGuard-MLOps",
    mlflow=True,
)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        """
        Track model metrics and model artifact using MLflow + DagsHub.
        """
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        """
        Train multiple ML models, select the best model,
        track metrics using MLflow, and save final model artifacts.
        """
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        """
        Load transformed train/test arrays and start model training.
        """
